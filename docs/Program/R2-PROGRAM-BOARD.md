...
| R2.6.1 Auth Session Patch | DONE | (pending tag) | r2.6.1 | 105 passed; 18 Playwright | Drive OAuth owner step | session + OAuth persistence |
| R2.7 Gmail Lifecycle | NOT_STARTED | | | | | paused for r2.6.1; resume after tag |
